...
if (isset($_POST['submit'])) {
    ...
    if (!$results) {
        ...
        echo "<script>alert('Order status updated'); window.location='viewOrdersmng.php'</script>";
    }
    ...
    if (!$results) {
        ...
        if (!$results2) {
            ...
            echo "<script>alert('Order Deleted'); window.location='viewOrdersmng.php'</script>";
        }
    }
}
?>
