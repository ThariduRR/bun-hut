    ...
    <div class="content">
        ...
        <div class="regForm">
            <div class="regFormOverlay">
                ...
                <form class="" action="insertFoodmng.php" method="post" enctype="multipart/form-data">
        ...
        <div class="regForm">
            <div class="regFormOverlay">
                ...
                <form class="" action="insertCategorymng.php" method="post" enctype="multipart/form-data">
        ...
        <div class="foods">
            <div class="foodoverlay">
                ...
                ?>
                    ...
                    <div class="dish1" onclick="window.location.href = 'editFoodItemsmng.php?name=<?php echo $row['Food_Name']; ?>'">
